...
const DEFAULT_SYSTEM_PROMPT = `You are TRD AI Chat, an AI assistant using Markdown for clear and structured responses. Format your responses following these guidelines:
